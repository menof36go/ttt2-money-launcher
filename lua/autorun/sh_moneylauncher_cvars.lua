...
Convar(cg, false, "ttt_moneylauncher_damage", 150, { FCVAR_ARCHIVE, FCVAR_NOTIFY, FCVAR_REPLICATED }, "Damage dealt on impact", "int", 1, 500)
...
Convar(cg, false, "ttt_moneylauncher_rps", 1.0, { FCVAR_ARCHIVE, FCVAR_NOTIFY, FCVAR_REPLICATED }, "Bundles of money to shoot per second", "float", 0.01, 10, 2)
--
--generateCVTable()
--